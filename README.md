...
✅ **智能问答** - 结合AI回答问题
✅ **内容总结** - 总结搜索结果
✅ **ZeroToken** - 免Token调用大模型
✅ **语音交互** - 支持语音输入和播放

详细说明请查看 [`docs/BAIDU_INTEGRATION.md`](docs/BAIDU_INTEGRATION.md)
